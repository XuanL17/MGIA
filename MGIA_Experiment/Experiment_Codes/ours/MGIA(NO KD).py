...
from utils import label_to_onehot, cross_entropy_for_onehot,label_to_onehot2
...
# CIFAR10 dictionary of numbers and names of labels
...
for i in range(50):
    ...
    for iters in range(100):
        def closure1():
            ...
            dummy_onehot_label = F.softmax(dummy_label1, dim=-1)
            dummy_loss = criterion1(dummy_pred, dummy_onehot_label)
        ...
        if iters % 10 == 0:
            ...
            print(iters, "Image loss:%.4f " % current_loss1.item(),'Text loss:%.4f:'%current_loss2.item(),'recovered sentence: [', recovery_ret, ']')
            # print(iters, 'Text loss:%.4f:'%current_loss2.item(),'recovered sentence: [', recovery_ret, ']')
